...
@Component
public class ValueDescriptorClientImpl extends ConsulDiscoveryClientTemplate implements ValueDescriptorClient {
	...
	protected String extractPath() {
		...
		try {
			...
			throw new DataValidationException("the URL is malformed, core.db.valuedescriptor.url: " + url);
		}
		return result;
	}
