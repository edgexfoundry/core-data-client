...
public interface EventClient {
	...
	List<Event> eventsForDevice(@PathParam("deviceId") String deviceId, @PathParam("limit") int limit);

	@GET
	@Path("/{start}/{end}/{limit}")
	List<Event> events(@PathParam("start") long start, @PathParam("end") long end, @PathParam("limit") int limit);
