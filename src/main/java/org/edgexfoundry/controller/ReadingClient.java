...
public interface ReadingClient {
	...
	List<Reading> readingsByNameAndDevice(@PathParam("name") String name, @PathParam("device") String device,
			@PathParam("limit") int limit);

	@GET
	@Path("/uomlabel/{uomLabel:.+}/{limit}")
	List<Reading> readingsByUoMLabel(@PathParam("uomLabel") String uomLabel, @PathParam("limit") int limit);
